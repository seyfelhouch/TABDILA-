        ...
        user.updatePhoneNumber(credential).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()) {
                    Toast.makeText(Verifyphone.this, "phone is updated !", Toast.LENGTH_SHORT).show();
                    progressBar.setVisibility(View.GONE);
                    Intent intent = new Intent(Verifyphone.this, ProfileActivity.class);
                    startActivity(intent);
                } else {
                    Toast.makeText(Verifyphone.this, "Failed to update phone!", Toast.LENGTH_SHORT).show();
                    progressBar.setVisibility(View.GONE);
                }
            }
        });
